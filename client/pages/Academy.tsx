...
export default function Academy() {
  ...
  return (
    <div className="min-h-screen px-6 py-20 relative">
      ...
      <div className="absolute top-32 left-10 opacity-20 animate-pulse pointer-events-none">
        <img
      ...
      <div
        className="absolute bottom-40 right-12 opacity-25 animate-bounce pointer-events-none"
