...
export default function Launchpad() {
  ...
  console.log("Launchpad wallet state:", { connected, publicKey });

  // Temporarily show the full interface regardless of wallet connection
  // if (!connected) {
  //   return wallet connection screen...
  // }
